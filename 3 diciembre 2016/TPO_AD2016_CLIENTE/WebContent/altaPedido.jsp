					...
					<form action="AltaPedido" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<input type="datetime-local" name="fechaCarga" id="fechaCarga" class="form-control" required>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-8">
								...
								<input type="datetime-local" name="fechaMaxima" id="fechaMaxima" class="form-control" required>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<input type="checkbox" name="solicitaTransporteDirecto" id="solicitaTransporteDirecto">
							</div>
							<div class="col-md-4">
								<label for="solicitaAvionetaParticular">Solicita avioneta particular</label>
								<input type="checkbox" name="solicitaAvionetaParticular" id="solicitaAvionetaParticular">
							</div>
						</div>
