...
public class Vehiculo {
	...
	public Vehiculo(int idVehiculo,String tipo, int volumen, int peso, int ancho,
			...
			PlanDeMantenimiento planDeMantenimiento, Sucursal sucursal) {
            super();
	...
	public VehiculoDTO toDTO(){
        return new VehiculoDTO (idVehiculo, tipo, volumen, peso, ancho, alto, profundidad, tara, 
                        ...
                        planDeMantenimiento.toDTO(), String.valueOf(sucursal.getIdSucursal()));
	}
	
	public float getVol70() {
		return (this.volumen*70/100);
	}
	
	public boolean podesLlevarEstasCargas(float cargas) {
		return (cargas <= this.getVolumen());
	}
}
