...
public class Despachar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int sucursal = Integer.parseInt((request.getParameter("sucursalOrigen")));
		System.out.println("sucursal int: " + sucursal);
		List<ViajeDTO> viajes = Delegate.getInstance().generarViajes(sucursal);
